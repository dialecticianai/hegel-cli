...
|--------|-----------|---------------------|-------|
| **Lines** | 12,634 | 7,849 | 20,483 |
| **Comments** | 1,750 | - | 1,750 |
| **Blank Lines** | 2,330 | - | 2,330 |
| **Total Lines** | 16,714 | 7,849 | 24,563 |
| **Files** | 74 | 36 | 110 |
...
-------------------------------------------------------------------------------
Rust                            74           2330           1750          12634
Markdown                         1             31              0             88
-------------------------------------------------------------------------------
SUM:                            75           2361           1750          12722
-------------------------------------------------------------------------------
```
...
| `commands/workflow/mod.rs` | 391 | 16 | 375 | 95.9% | ✅ |
