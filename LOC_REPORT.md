...
| `commands/workflow/mod.rs` | 703 | 18 | 685 | 97.4% | ✅ |
| `commands/workflow/tests/commands.rs` | 419 | 419 | 0 | 0.0% | ✅ (infra) |
| `commands/workflow/tests/integration.rs` | 58 | 58 | 0 | 0.0% | ✅ |
...
| `test_helpers/workflow.rs` | 300 | 300 | 0 | 0.0% | ✅ (infra) |
