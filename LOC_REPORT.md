...
|--------|-----------|---------------------|-------|
| **Lines** | 20,570 | 16,350 | 36,920 |
| **Comments** | 3,057 | - | 3,057 |
| **Blank Lines** | 3,861 | - | 3,861 |
| **Total Lines** | 27,488 | 16,350 | 43,838 |
| **Files** | 136 | 86 | 222 |
...
-------------------------------------------------------------------------------
Rust                           136           3861           3057          20570
Markdown                        18            171              0            541
-------------------------------------------------------------------------------
SUM:                           154           4032           3057          21111
-------------------------------------------------------------------------------
```
...
| `commands/reflect.rs` | 209 | 182 | 27 | 12.9% | ✅ |
| `commands/review.rs` | 314 | 140 | 174 | 55.4% | ✅ |
...
| `commands/workflow/listing.rs` | 196 | 196 | 0 | 0.0% | ✅ |
| `commands/workflow/mod.rs` | 367 | 367 | 0 | 0.0% | ✅ |
| `commands/workflow/stash.rs` | 156 | 156 | 0 | 0.0% | ✅ |
...
| `commands/workflow/tests/mod.rs` | 84 | 84 | 0 | 0.0% | ✅ |
...
| `engine/mod.rs` | 328 | 319 | 9 | 2.7% | ✅ |
| `engine/template.rs` | 160 | 160 | 0 | 0.0% | ✅ |
...
| `tui/tabs/phases.rs` | 243 | 163 | 80 | 32.9% | ✅ |
...
| `.ddd/refactor/20260526-dry-and-idiomatic-cleanup.md` | 240 |
