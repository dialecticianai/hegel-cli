...
|--------|-----------|---------------------|-------|
| **Lines** | 9,746 | 5,207 | 14,953 |
| **Comments** | 1,373 | - | 1,373 |
| **Blank Lines** | 1,796 | - | 1,796 |
| **Total Lines** | 12,915 | 5,207 | 18,122 |
| **Files** | 57 | 28 | 85 |
...
-------------------------------------------------------------------------------
Rust                            57           1796           1373           9746
-------------------------------------------------------------------------------
SUM:                            57           1796           1373           9746
-------------------------------------------------------------------------------
```
...
| `tui/tabs/events.rs` | 107 | 88 | 19 | 17.8% | ✅ |
