...
**Tool**: cargo-llvm-cov
**Overall Coverage**: **83.05%** lines | **82.38%** regions | **84.09%** functions

## Summary

```
TOTAL                                         18454              3252    82.38%         974               155    84.09%       11239              1905    83.05%           0                 0         -
```
...
| `src/engine/handlebars.rs` | 96.35% | 94.70% | 100.00% | 🟢 Excellent |
...
- `src/config.rs` - 91.67%
- `src/engine/handlebars.rs` - 96.35%
