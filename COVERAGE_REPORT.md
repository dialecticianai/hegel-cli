...
**Tool**: cargo-llvm-cov
**Overall Coverage**: **91.05%** lines | **90.02%** regions | **89.09%** functions

## Summary

```
TOTAL                                  14540              1451    90.02%         788                86    89.09%        8691               778    91.05%           0                 0         -
```
...
| `commands/fork/mod.rs` | 73.14% | 76.09% | 95.24% | 🟡 Good |
...
| `main.rs` | 40.74% | 34.11% | 100.00% | 🟠 Moderate |
