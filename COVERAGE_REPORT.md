...
**Tool**: cargo-llvm-cov
**Overall Coverage**: **90.00%** lines | **89.10%** regions | **88.88%** functions

## Summary

```
TOTAL                                      15529              1693    89.10%         836                93    88.88%        9336               934    90.00%           0                 0         -
```
...
| `src/embedded.rs` | 75.93% | 61.19% | 50.00% | 🟡 Good |
