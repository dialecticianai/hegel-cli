...
**Tool**: cargo-llvm-cov
**Overall Coverage**: **91.51%** lines | **90.43%** regions | **88.87%** functions

## Summary

```
TOTAL                                  14089              1348    90.43%         764                85    88.87%        8454               718    91.51%           0                 0         -
```
...
| `commands/fork.rs` | 82.57% | 89.26% | 100.00% | 🟡 Good |
