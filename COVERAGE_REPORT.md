...
**Tool**: cargo-llvm-cov
**Overall Coverage**: **91.63%** lines | **90.45%** regions | **88.76%** functions

## Summary

```
TOTAL                                  13938              1331    90.45%         756                85    88.76%        8344               698    91.63%           0                 0         -
```
...
| `main.rs` | 44.00% | 36.97% | 100.00% | 🟠 Moderate |
