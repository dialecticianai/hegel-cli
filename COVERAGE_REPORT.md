...
**Tool**: cargo-llvm-cov
**Overall Coverage**: **86.61%** lines | **85.53%** regions | **85.98%** functions

## Summary

```
TOTAL                                      17442              2523    85.53%         927               130    85.98%       10608              1420    86.61%           0                 0         -
```
...
| `src/analyze/sections.rs` | 89.66% | 84.24% | 88.24% | 🟡 Good |
