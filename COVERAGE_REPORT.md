...
**Last Updated**: 2025-11-04 13:11
**Tool**: cargo-llvm-cov
**Overall Coverage**: **88.51%** lines | **87.66%** regions | **87.12%** functions

## Summary

```
TOTAL                                      15995              1974    87.66%         862               111    87.12%        9648              1109    88.51%           0                 0         -
```
...
| `src/commands/analyze/mod.rs` | 41.96% | 49.07% | 57.89% | 🟠 Moderate |
...
| `src/commands/meta.rs` | 64.46% | 70.59% | 83.33% | 🟠 Moderate |
...
| `src/commands/workflow/mod.rs` | 50.55% | 51.01% | 50.00% | 🟠 Moderate |
| `src/commands/workflow/transitions.rs` | 87.04% | 81.99% | 46.15% | 🟡 Good |
...
| `src/main.rs` | 40.91% | 35.26% | 100.00% | 🟠 Moderate |
...
| `src/metrics/mod.rs` | 96.15% | 94.96% | 84.21% | 🟢 Excellent |
...
- `src/commands/workflow/transitions.rs` - 87.04%
