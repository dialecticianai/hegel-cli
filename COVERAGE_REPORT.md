...
**Tool**: cargo-llvm-cov
**Overall Coverage**: **91.62%** lines | **90.47%** regions | **88.87%** functions

## Summary

```
TOTAL                                  14074              1341    90.47%         764                85    88.87%        8432               707    91.62%           0                 0         -
```
...
| `commands/fork.rs` | 90.80% | 93.28% | 100.00% | 🟢 Excellent |
