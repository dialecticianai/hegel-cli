...
**Tool**: cargo-llvm-cov
**Overall Coverage**: **80.59%** lines | **80.27%** regions | **80.92%** functions

## Summary

```
TOTAL                                         21555              4252    80.27%        1127               215    80.92%       13176              2557    80.59%           0                 0         -
```
...
| `src/commands/review.rs` | 100.00% | 100.00% | 100.00% | 🟢 Excellent |
