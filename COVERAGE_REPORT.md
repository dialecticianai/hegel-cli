...
**Tool**: cargo-llvm-cov
**Overall Coverage**: **90.81%** lines | **89.74%** regions | **88.93%** functions

## Summary

```
TOTAL                                  14439              1481    89.74%         777                86    88.93%        8648               795    90.81%           0                 0         -
```
...
| `commands/fork.rs` | 69.00% | 71.28% | 95.24% | 🟠 Moderate |
