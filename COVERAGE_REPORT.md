...
**Tool**: cargo-llvm-cov
**Overall Coverage**: **83.14%** lines | **82.53%** regions | **84.11%** functions

## Summary

```
TOTAL                                         18657              3259    82.53%         982               156    84.11%       11319              1908    83.14%           0                 0         -
```
...
| `src/engine/handlebars.rs` | 97.70% | 96.30% | 100.00% | 🟢 Excellent |
...
- `src/config.rs` - 91.67%
- `src/engine/handlebars.rs` - 97.70%
