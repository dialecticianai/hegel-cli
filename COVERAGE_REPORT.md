...
**Tool**: cargo-llvm-cov
**Overall Coverage**: **90.45%** lines | **89.47%** regions | **89.05%** functions

## Summary

```
TOTAL                                      14970              1577    89.47%         813                89    89.05%        8998               859    90.45%           0                 0         -
```
