...
**Tool**: cargo-llvm-cov
**Overall Coverage**: **91.65%** lines | **91.02%** regions | **87.95%** functions

## Summary

```
TOTAL                              12919              1160    91.02%         730                88    87.95%        7602               635    91.65%           0                 0         -
```
...
| `commands/workflow.rs` | 90.69% | 90.20% | 87.84% | 🟢 Excellent |
...
| `main.rs` | 46.67% | 40.95% | 100.00% | 🟠 Moderate |
