...
**Tool**: cargo-llvm-cov
**Overall Coverage**: **76.83%** lines | **75.94%** regions | **77.42%** functions

## Summary

```
TOTAL                                         18118              4359    75.94%         983               222    77.42%       11236              2603    76.83%           0                 0         -
```
...
| `src/main.rs` | 51.38% | 40.60% | 100.00% | 🟠 Moderate |
