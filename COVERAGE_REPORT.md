...
**Last Updated**: 2025-11-12 20:44
**Tool**: cargo-llvm-cov
**Overall Coverage**: **76.20%** lines | **75.30%** regions | **77.04%** functions

## Summary

```
TOTAL                                         18010              4449    75.30%         980               225    77.04%       11191              2663    76.20%           0                 0         -
```
...
| `src/main.rs` | 47.41% | 39.57% | 100.00% | 🟠 Moderate |
