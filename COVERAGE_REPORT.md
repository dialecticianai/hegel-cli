...
**Tool**: cargo-llvm-cov
**Overall Coverage**: **75.71%** lines | **74.93%** regions | **76.93%** functions

## Summary

```
TOTAL                                         19229              4820    74.93%        1101               254    76.93%       11976              2909    75.71%           0                 0         -
```
...
| `src/tui/tabs/phases.rs` | 96.90% | 96.85% | 100.00% | 🟢 Excellent |
