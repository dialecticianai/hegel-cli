...
**Tool**: cargo-llvm-cov
**Overall Coverage**: **92.60%** lines | **91.47%** regions | **87.67%** functions

## Summary

```
TOTAL                              10811               922    91.47%         576                71    87.67%        6624               490    92.60%           0                 0         -
```
...
| `commands/workflow.rs` | 90.49% | 89.33% | 83.72% | 🟢 Excellent |
