...
**Tool**: cargo-llvm-cov
**Overall Coverage**: **89.86%** lines | **88.84%** regions | **87.94%** functions

## Summary

```
TOTAL                                      15776              1761    88.84%         854               103    87.94%        9493               963    89.86%           0                 0         -
```
...
| `src/main.rs` | 39.06% | 33.55% | 100.00% | 🔴 Needs Work |
