...
//!    a. Check if a cowboy already exists for this exact gap (matching start/end times)
//!    b. If yes: keep it
//!    c. If no: create one
//!    d. Remove any other cowboys in this gap (duplicates or incorrect timestamps)
...
/// Ensures exactly one cowboy per gap between non-synthetic workflows
///
